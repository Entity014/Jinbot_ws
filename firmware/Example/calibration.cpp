...
ESP32Encoder motor4_encoder(COUNTS_PER_REV4, MOTOR4_ENCODER_INV);
...
ESP32Encoder *encoders[4] = {&motor1_encoder, &motor2_encoder, &motor3_encoder, &motor4_encoder};
...
void printSummary()
{
    ...
    Serial.println(encoders[1]->getCount());
    ...
    Serial.println(encoders[3]->getCount());
    Serial.println("");

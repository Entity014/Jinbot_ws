...
ESP32Encoder::ESP32Encoder(int counts_per_rev, bool invert, bool always_interrupt_, enc_isr_cb_t enc_isr_cb, void *enc_isr_cb_data) : always_interrupt{always_interrupt_},
...
float ESP32Encoder::getRPM()
{
	long encoder_ticks = this->getCount();

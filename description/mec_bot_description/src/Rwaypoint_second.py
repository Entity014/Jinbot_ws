...
def main():
    ...
    initial_pose.pose.position.x = -4.2
    initial_pose.pose.position.y = 7.7
    (
        initial_pose.pose.orientation.x,
        initial_pose.pose.orientation.y,
        initial_pose.pose.orientation.z,
        initial_pose.pose.orientation.w,
    ) = quaternion_from_euler(0, 0, math.radians(80))
    ...
    goal_pose1.pose.position.x = -0.9
    goal_pose1.pose.position.y = 7.8
    (
    ...
    goal_pose2.pose.position.y = 3.3
    (

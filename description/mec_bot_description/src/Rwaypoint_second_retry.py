...
def main():
    ...
    initial_pose.pose.position.y = 4.7
    (
    ...
    goal_pose1.pose.position.y = 8.0
    (
    ...
    goal_pose2.pose.position.x = -0.9
    goal_pose2.pose.position.y = 7.8
    (
    ...
    goal_pose3.pose.position.y = 3.3
    (
